            ...
            <template v-if="!hasScope">
                <v-flex d-flex xs12 md8 mt-5 offset-md2>
                    <v-alert value="true" type="error" >
                        <b>Algumas permissões estão faltando</b>. Por favor, refaça o login e aceite pelo menos as permissões de do seu gênero, informações sobre suas caronas e de criação/edição delas.
                    </v-alert>
                </v-flex>
                <v-flex
                d-flex
                            ...
                            <v-flex d-flex xs12 md7>
                                <v-layout row wrap align-start>
                                    ...
                                    <v-flex d-flex xs12 fill-height>
                                        <Passengers :trip="trip" @passengerModified="reload()" />
                                    </v-flex>
                                </v-layout>
                            </v-flex>
