        ...
        <template slot="card" slot-scope="theme">
            <v-card-title primary-title>
                ...
                <v-flex v-if="trip.status == 'approved'" xs12>
                    ...
                    <v-flex xs12>
                        <div class="title mb-0 font-weight-thin">
                            <b>{{ capitalize(driver.driver.car_make) }}
                                {{ capitalize(driver.driver.car_model) }}</b>
                        </div>
                    </v-flex>
                    <v-flex xs12>
                        <div class="title mb-0 font-weight-thin">
                            <b>Cor: </b>{{ capitalize(driver.driver.car_color) }}
                        </div>
                    </v-flex>
                </v-flex>
                <v-flex xs12>
                    ...
                    <v-flex xs12>
                        <div class="title mb-0 font-weight-thin">
                            <b>{{
                                getUniversity(driver.student.university)
                            }}</b>
                        </div>
                    </v-flex>
                    <v-flex xs12>
                        <div class="title mb-0 font-weight-thin">
                            <b>{{ capitalize(driver.student.course) }}
                                {{ driver.student.enroll_year }}</b>
                        </div>
                    </v-flex>
                </v-flex>
                <v-flex xs12>
                    ...
                    <v-flex xs12>
                        <div class="title mb-0 font-weight-thin">
                            <b>Animais:</b> {{ driverPrefs.likes_pets }}
                        </div>
                    </v-flex>
                    <v-flex xs12>
                        <div class="title mb-0 font-weight-thin">
                            <b>Fumar:</b> {{ driverPrefs.likes_smoking }}
                        </div>
                    </v-flex>
                    <v-flex xs12>
                        <div class="title mb-0 font-weight-thin">
                            <b>Conversar:</b> {{ driverPrefs.likes_talking }}
                        </div>
                    </v-flex>
                    <v-flex xs12>
                        <div class="title mb-0 font-weight-thin">
                            <b>Música:</b> {{ driverPrefs.likes_music }}
                        </div>
                    </v-flex>
                </v-flex>
            </v-card-title>
